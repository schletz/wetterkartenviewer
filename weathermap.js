    ...
    Weathermap.createPanels([
        ...
        [
           // Meteociel ECMWF 500hPa EU
            ...
            { start: 0, step: 3, stop: 141, layer: 1, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 13, "ecmwfnh") },
            { start: 144, step: 6, stop: 240, layer: 1, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 13, "ecmwfnh") },
        ],
        // *****************************************************************************************
        // 0.1 850 hPa Layer
        // *****************************************************************************************
        ...
        [
            ...
            { start: 0, step: 3, stop: 141, layer: 0, urlGenerator: Weathermap.getWzUrlGenerator(9, "ECMOP", "ME") },
            { start: 144, step: 6, stop: 240, layer: 0, urlGenerator: Weathermap.getWzUrlGenerator(9, "ECMOP", "ME") },

            // Meteociel ThetaE
            { start: 0, step: 3, stop: 141, layer: 1, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 7, "ecmwfeu") },
            { start: 144, step: 6, stop: 240, layer: 1, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 7, "ecmwfeu") },

            // Meteociel ThetaE
            { start: 0, step: 3, stop: 141, layer: 2, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 7, "ecmwfeuw") },
            { start: 144, step: 6, stop: 240, layer: 2, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 7, "ecmwfeuw") },            
        ],
        // *****************************************************************************************
        // 1.0 300hPa
        // *****************************************************************************************
        ...
        // *****************************************************************************************
        [
            // Meteociel Precipiation
            { start: 0, step: 3, stop: 141, layer: 0, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 2, "ecmwfeuw") },
            { start: 144, step: 6, stop: 240, layer: 0, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 2, "ecmwfeuw") },

            // Meteociel Precipiation
            { start: 0, step: 3, stop: 141, layer: 1, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 2, "ecmwfeu") },
            { start: 144, step: 6, stop: 240, layer: 1, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 2, "ecmwfeu") },

            // Meteociel Precipiation accum
            { start: 0, step: 3, stop: 141, layer: 2, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 25, "ecmwfeuw") },
            { start: 144, step: 6, stop: 240, layer: 2, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 25, "ecmwfeuw") },


            // Meteociel Precipiation accum
            { start: 0, step: 3, stop: 141, layer: 3, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 25, "ecmwfeu") },
            { start: 144, step: 6, stop: 240, layer: 3, urlGenerator: Weathermap.getMeteocielUrlCenerator("ecmwf", 25, "ecmwfeu") },
        ...
        [
            ...
            // Meteociel ARPEGE DE
            { start: 1, step: 1, stop: 114, layer: 1, urlGenerator: Weathermap.getMeteocielUrlCenerator("arpege", 11, "arpegede") },

            // Meteociel ARPEGE DE
            { start: 1, step: 1, stop: 114, layer: 2, urlGenerator: Weathermap.getMeteocielUrlCenerator("arpege", 38, "arpegede") },
        ]
    ]);
